...
class TelephoneCascadeBuilder:
    ...
    def build(
        ...
        *,
        ...
        self.log(
            f"Telephone tree mode: roots={len(roots)} depth={cfg.depth} "
            f"k={cfg.branching_factor} cap={cfg.max_samples_total}"
        )
        ...
        with jsonl_handle as f_jsonl:
            ...
            def _emit(rec: Dict[str, object], text: str) -> None:
                ...
                # Write TXT node (optional)
                if cfg.export_txt_nodes:
            ...
            for root_id, root_text, meta in roots:
                ...
                # Make the root's node id stable: sample_id == root_id
                rec = {
                    "sample_id": root_id,
                    "root_id": root_id,
                    "parent_id": None,
